    ...
    >
      ...
      <Switch>
        <Route
          exact
          path="/"
          render={(props) => <Home {...props} user={user} width={width} />}
        />
        <Route
          exact
          path="/signup"
        ...
        />
        <ProtectedRoute exact path="/users" component={UsersList} user={user} />
        <ProtectedRoute
          exact
          path="/users/add"
          component={AddUser}
        ...
        <ProtectedRoute exact path="/pets" component={PetsList} user={user} />
        <ProtectedRoute
          exact
          path="/pets/:id"
